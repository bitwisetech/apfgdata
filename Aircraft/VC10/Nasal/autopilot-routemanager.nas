...
var listenerApHeadingSwitchFunc = func {
    ...
    #polly     print('lstnApHdgSwFun 133  kpForHeadingCurrent**: ', kpForHeadingCurrent);
		setprop("autopilot/internal/target-kp-for-heading-deg", (kpForHeadingDeg * 0.05));
    #polly print('lstnApHdgSwFun 136  kpForHeadingDeg**: ', (kpForHeadingDeg * 0.05));
...
var listenerApHeadingPassiveModeFunc = func {
	...
	if (	getprop("autopilot/locks/heading") == "true-heading-hold" and
		...
		setprop("autopilot/internal/target-kp-for-heading-deg", (kpForHeadingDeg * 0.05));
    #polly 
    print('lstnApHdgSwFun 160  kpForHeadingDeg**: ', (kpForHeadingDeg * 0.05));
		interpolate("autopilot/internal/target-kp-for-heading-deg", kpForHeadingDeg, 1);
	}
}
...
var listenerApHeadingFunc = func {
	if (	getprop("autopilot/locks/heading") == "wing-leveler" or
      ...
      #polly print('lstnApHdgFunc 183   kpForHeadingCurrent: ', kpForHeadingCurrent);
      ...
      #polly print('lstnApHdgFunc  193 kpForHeadingCurrent: ', kpForHeadingCurrent);
    ...
    #polly print('lstnApHdgFunc 206  kpForHeadingCurrent: ', kpForHeadingCurrent);
    ...
    #polly    print(' IAS Kp Adj    236  kpForHeadingDeg**: ', kpForHeadingDegCurrent);
...
var listenerApNav1NearFarFunc = func {
	if (getprop("autopilot/locks/heading") == "nav1-hold") {
		...
		#polly var navDistance = getprop("instrumentation/nav[0]/nav-distance");
		var navDistance = getprop("instrumentation/nav[0]/nav-distance") or 9999;
